...
import {
  require_cjs
} from "./chunk-FWWF47DY.js";
import {
  __spreadValues,
  __toESM
} from "./chunk-YHCV7DAQ.js";

// node_modules/.pnpm/primeng@20.2.0_3dc82578ec719038d820d6e01bcf6b79/node_modules/primeng/fesm2022/primeng-config.mjs
var import_rxjs = __toESM(require_cjs(), 1);

// node_modules/.pnpm/@primeuix+styled@0.7.3/node_modules/@primeuix/styled/dist/index.mjs
...
var b2 = {
  ...
  getPreset({
    ...
    if (s2(t) && r.transform !== "strict") {
      let y = e.replace("-directive", ""), m2 = t, {
        ...
        dark: te
      } = g, re = v(g, ["dark"]), K = s2(O) ? this._toVariables({
        [y]: h(h({}, O), z2)
      }, r) : {}, A2 = s2(L) ? this._toVariables({
        [y]: h(h({}, L), re)
      }, r) : {}, X = s2(V) ? this._toVariables({
        [y]: h(h({}, V), te)
      }, r) : {}, [G2, U2] = [(f = K.declarations) != null ? f : "", K.tokens || []], [B, I] = [(x = A2.declarations) != null ? x : "", A2.tokens || []], [H, W] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y, H, "dark", "variable", r, i2, a2, n);
  ...
  getCommonStyleSheet({
    ...
    let n = this.getCommon({
      ...
      set: i2,
      defaults: a2
    }), l = Object.entries(s3).reduce((o, [c, m2]) => o.push(`${c}="${m2}"`) && o, []).join(" ");
  ...
  getStyleSheet({
    ...
    let n = {
      ...
      set: i2,
      defaults: a2
    }, l = (c = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c.css, o = Object.entries(s3).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
    ...
    if (s2(t)) {
      ...
      if (s3 !== "style") {
        ...
        t = r === "dark" ? c.reduce((m2, {
          type: d,
          selector: u
        }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m2), "") : C(l != null ? l : ":root,:host", t);
      }
      if (o) {
        let c = {
          name: "primeui",
...
var S = {
  ...
  transformCSS(e = "", t, r = "style", s3) {
    return b2.transformCSS(e, t, s3, r, this.options, {
      layerNames: this.setLayerNames.bind(this)
    }, this.defaults);
  },
...
// node_modules/.pnpm/primeng@20.2.0_3dc82578ec719038d820d6e01bcf6b79/node_modules/primeng/fesm2022/primeng-usestyle.mjs
var _id = 0;
...
// node_modules/.pnpm/primeng@20.2.0_3dc82578ec719038d820d6e01bcf6b79/node_modules/primeng/fesm2022/primeng-base.mjs
var base = {
  _loadedStyleNames: /* @__PURE__ */ new Set(),
  getLoadedStyleNames() {
    return this._loadedStyleNames;
...
//# sourceMappingURL=chunk-5HUNX727.js.map
